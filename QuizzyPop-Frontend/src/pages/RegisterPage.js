...
const RegisterPage = () => {
  ...
  const Registervalidation = () => {
    ...
    alert
      ("You have been successfull register");
  }
          ...
          <Form onSubmit={submitHandler}>
            ...
            >
              ...
              <Form.Control
                ...
                value={phoneNumber}
                pattern="[1-9]{1}[0-9]{9}"
                title="must contain 10 digit number"
                onChange={(e) => {
            ...
            <Button variant=""
              ...
              className="my-3" type="submit" style={{ backgroundColor: "rgb(68 177 49)", color: "white" }}>
              Register
            </Button>
          </Form>
